  ...
  return (
    <div>
      ...
      <div className='flex justify-center mt-4 gap-4'>
        <a href="https://wa.me/8218532681" target="_blank"><button className='p-4 px-6 flex flex-row gap-2 text-s bg-orange-500 outline-none border-0 rounded-full cursor-pointer hover:bg-orange-600 transition-all duration-300 ease-in-out hover:scale-105'>
